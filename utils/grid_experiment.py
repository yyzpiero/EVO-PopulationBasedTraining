...
from run_utils import call_experiment


DIV_LINE_WIDTH = 80


def call_experiment_grid(thunk, thunk_params_dict_list, args, cpu_num, **kwargs):
    """
    ...
    try:
        ...
        print("Main fucntion runs {}".format(cmd))
...
if __name__ == '__main__':    
    ...
    for i in range(0, len(params_dict_list), cpu_num):
        ...
        call_experiment_grid(thunk=func,
                        thunk_params_dict_list=cur_params_dict_list,
                        args=None,
                        cpu_num=cpu_num)
        # var = params_dict
        # call_experiment(exp_name=str(i)+"exp", thunk=func, seed=0, num_cpu=cpu_num, data_dir=None, 
        #              datestamp=False, **var)